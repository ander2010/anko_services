...
def main() -> int:
    ...
    pdf_path = os.getenv("PROCESS_REQUEST_FILE_PATH", "documents/2/01_Harry_Potter_and_The_Philosophers_Stone-1-100.pdf")#"documents/La_sabiduria_de_los_estoicos.pdf"
