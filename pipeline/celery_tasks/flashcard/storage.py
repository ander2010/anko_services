...
class FlashcardStorage:
    ...
    def _model_to_dict(card: Any) -> dict[str, Any]:
        return {
            ...
            "back_image": getattr(card, "back_image", None),
            "back_image_height": getattr(card, "back_image_height", None),
            "back_image_width": getattr(card, "back_image_width", None),
            "back_image_size_bytes": getattr(card, "back_image_size_bytes", None),
            "back_image_original_size_bytes": getattr(card, "back_image_original_size_bytes", None),
            "back_image_was_optimized": getattr(card, "back_image_was_optimized", None),
