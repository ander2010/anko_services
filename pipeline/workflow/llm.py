    ...
    def generate(
        ...
        *,
        ...
        prompt = (
            ...
            "Before generating ANY question, examine the chunk for meaningful concepts, patterns, relationships, rules, principles, or insights that a learner could understand and apply without seeing the source.\n"
            "Concepts can be:\n"
            "- Explicit (definitions, formulas, procedures, constraints)\n"
            "- Implicit (themes, cause-effect, moral reasoning, social dynamics, patterns, abstractions)\n"
            "If no such concept can be found, return EXACTLY: {\"questions\": []}\n\n"
            ...
            "Before writing a question, internally extract a GENERAL, DOMAIN-LEVEL FACT, RULE, PRINCIPLE, RELATIONSHIP, OR PROCESS expressed in the chunk.\n"
            "Focus on learnable, semantic knowledge that can be understood and applied without referencing the source text.\n\n"
            "DOCUMENT TYPE & DOMAIN AWARENESS:\n"
            "The source text may belong to ANY domain, known or unknown, including:\n"
            "- Sciences (mathematics, physics, chemistry, biology, engineering, computer science)\n"
            "- Social sciences, history, law, philosophy, economics\n"
            "- Fiction, poetry, drama, narrative prose, essays, descriptive texts\n"
            "- Investigative, religious, or other niche/unusual domains\n\n"
            "Valid learning value may include ANY type of insight, principle, relationship, pattern, or abstract concept, for example:\n"
            "- Definitions, rules, formulas, constraints\n"
            "- Causal, logical, or systemic relationships\n"
            "- Problem-solving strategies, reasoning patterns, or processes\n"
            "- Abstract structures, hierarchies, or dependencies\n"
            "- Behavioral, social, ethical, or emotional dynamics\n"
            "- Thematic, symbolic, or conceptual interpretations\n"
            "- Any idea, principle, or pattern that a learner could understand and apply without needing the original source\n\n"
